...
print("Total # of load recevied",Number_of_loans)
...
print("Total of all loans", Total_of_all_loans)
...
print("Fair value of the loan is ", present_value)
